                                ...
                                {characters.map(char => (
                                    <div key={char.id} className="bg-gray-955/20 border border-gray-850 p-4 rounded-2xl flex flex-col justify-between space-y-3 relative group">
                                        ...
                                        <div className="flex gap-2 pt-2 border-t border-gray-850/60 justify-end">
                                            ...
                                            {(char.jobStatus === "QUEUED" || char.jobStatus === "PROCESSING") && (
                                                <button onClick={() => updateCharacterProfile(char.id, { jobStatus: undefined, jobId: undefined })}
                                                    className="px-2.5 py-1 bg-gray-800 hover:bg-gray-750 border border-gray-700 text-gray-400 hover:text-white text-[10px] font-bold rounded-lg transition-all font-sans">
                                                    Reset
                                                </button>
                                            )}
                                                                ...
                                                                <div className="flex items-center justify-between gap-2">
                                                                    ...
                                                                    <div className="flex items-center gap-1.5">
                                                                        ...
                                                                        {(shot.jobStatus === "QUEUED" || shot.jobStatus === "PROCESSING") && (
                                                                            <button onClick={() => updateShot(scene.id, shot.id, { jobStatus: "IDLE", jobId: undefined })}
                                                                                className="px-1.5 py-0.5 bg-gray-800 hover:bg-gray-700 border border-gray-700 text-gray-400 hover:text-white text-[9px] font-bold rounded transition-all font-sans">
                                                                                Reset
                                                                            </button>
                                                                        )}
                                                                    </div>
