...
const API_KEY_FIELDS = [
    ...
    { key: "elevenlabs", label: "ElevenLabs API Key", desc: "Premium TTS voices" },
    { key: "freesound_api_key", label: "Freesound API Key", desc: "Ambient SFX library" },
    { key: "freesound_client_id", label: "Freesound Client ID", desc: "Freesound OAuth" },
    { key: "runpod_api_key", label: "RunPod API Key", desc: "GPU worker endpoint" },
